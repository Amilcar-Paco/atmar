...
import avatar4 from 'assets/images/team/member4.jpg';
import avatar5 from 'assets/images/team/member5.jpg';
import avatar6 from 'assets/images/team/member6.jpg';
import avatar7 from 'assets/images/team/member7.jpg';
import avatar8 from 'assets/images/team/member8.jpg';
  ...
  return (
    <Box as="section" id="team" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          sx={styles.heading}
          title="Conheça algumas das nossas actividades"
          description="As actividades são implementadas na sede da associação na província do Maputo, distrito de
          Marracuene, no Bairro Mumemo."
        />
      </Container>
      <Box
        sx={{
