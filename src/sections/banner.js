...
import illustration from 'assets/images/banner-illustration.jpg';
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            ...
            description="Associação Tlhangano Wava Makweru aku Rhulene"
          />
...
const styles = {
  ...
  heading: {
    mb: [30],
    maxWidth: [null, null, null, 500, 560, 830],
    h2: {
